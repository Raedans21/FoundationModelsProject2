...
from FoundationModelsProject2.models import RNNLanguageModel
...
MODEL_PATH = "../model_training/saved_models/rnn.pth"
...
if train_losses is not None:
    model_eval.gen_loss_curve_plot(train_losses, val_losses, "../model_training/loss_plots/rnn_loss_curve.png")

...
from FoundationModelsProject2.models import LSTMLanguageModel
...
MODEL_PATH = "../model_training/saved_models/lstm.pth"
...
# Generate loss curve if model was newly trained
if train_losses is not None:
    model_eval.gen_loss_curve_plot(train_losses, val_losses, "../model_training/loss_plots/lstm_loss_curve.png")
